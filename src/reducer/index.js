...
function reducer(state = initialState, action) {
    switch (action.type) {
        ...
        case ORDENAR_POR_PUNTUACION:
            ...
            case ORDENAR_POR_PUNTUACION_DIETA:
                let ordenar_por_puntuacion_dieta;
                if (action.payload === "ASC") {
                    ordenar_por_puntuacion_dieta = state.recetas.sort((a, b) => {
                        if (a.dieta.length > b.dieta.length) return 1;
                        if (a.dieta.length < b.dieta.length) return -1;
                        return 0;
                    });
                } else if (action.payload === "DESC") {
                    ...
                    ordenar_por_puntuacion_dieta = state.todasLasRecetas
                }
                return {
                    ...state,
                    recetas: ordenar_por_puntuacion_dieta
                }
